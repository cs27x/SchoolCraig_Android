 ...
 * interface.
 */
public class PostingListFragment extends ListFragment {
	private static PostingAdapter postingAdapter;
     ...
     * clicks.
     */
    private Callbacks mCallbacks = sPostingCallbacks;
     ...
     */
    private static Callbacks sPostingCallbacks = new Callbacks() {
        @Override
        public void onItemSelected(int index) {
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        postingAdapter = PostingAdapter.getInstance(this.getActivity().getApplicationContext());
        setListAdapter(postingAdapter);
    }
    ...
    public void onResume() {
    	...
    	if(!PostingListActivity.filtered) {
            //Log.d("CLEARDATA", "onResume(): Clear data");
            //postingAdapter.clearData();
            Log.d("LOADDATA", "onResume(): Loading data");
